...
builder = WineBuilder(container, [{
    ...
    "name": "winemac-force-update-display-devices-cx24",
    "operatingSystems": "darwin",
    "architectures": ["amd64"]
}, {
    "name": "winespool-native-print-dialog-hack_cx24",
    "operatingSystems": "darwin",
    "architectures": []
}, {
...
builder.build("darwin", "amd64", "winecx-25.1.0", "cx", "https://github.com/PhoenicisOrg/winecx")
builder.archive("shape3D_wine_25_1_0.tar.gz")
